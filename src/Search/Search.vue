<template>
    <div class="container rows">
        <div class="cols" style="font-weight: bold; align-items: center;">
            ...
            <a href="https://www.female-anatomy-for-artist.com/" target="_blank">Female Anatomy for Artist</a>
        ...
        <div class="fill cols">
            <div class="rows" style="width: 320px; height: 100%; overflow: auto;">
                ...
                <div class="description">
                    <div>
                        ...
                        <a href="https://www.female-anatomy-for-artist.com"
                           target="_blank">female-anatomy-for-artist.com</a>.
                    </div>
                    <div>
            ...
            >
                ...
                <a v-for="photo in searchResults"
                   class="item photo"
                   :data-id="photo.id"
                   :href="`https://www.female-anatomy-for-artist.com/photos/show/id/${photo.id}`"
                   rel="noreferrer"
                   target="_blank"
                >
                    <img :src="photo.url"
